  ...
  return (
    <div className="Vv" style={{ width: 393, height: 850, position: 'relative', background: 'white' }}>
      <div className="Frame2" style={{ height: 186, paddingTop: 135, paddingBottom: 15, paddingLeft: 14, paddingRight: 140, left: 0, top: -64, position: 'absolute', background: '#F1C010', justifyContent: 'flex-start', alignItems: 'center', gap: 101, display: 'flex' }}>
        ...
        <div className="Go" style={{ color: 'black', fontSize: 30, fontFamily: 'Inter', fontWeight: '400', wordWrap: 'break-word' }} >揪團 GO</div>
      </div>
      ...
      <div style={{ left: 20, top: 144, position: 'absolute', textAlign: 'center', color: 'black', fontSize: 20, fontFamily: 'Inter', fontWeight: '400', wordWrap: 'break-word' }}>團購主基本資訊</div>
      ...
      <div className="Oliver" style={{ left: 34, top: 431, position: 'absolute', textAlign: 'center', color: 'black', fontSize: 20, fontFamily: 'Inter', fontWeight: '400', wordWrap: 'break-word' }}>名稱 : Oliver </div>
      <div className="0912345678" style={{ left: 34, top: 467, position: 'absolute', textAlign: 'center', color: 'black', fontSize: 20, fontFamily: 'Inter', fontWeight: '400', wordWrap: 'break-word' }}>連絡電話 : 0912345678</div>
    </div>
  );
}
